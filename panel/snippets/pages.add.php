    ...
    <fieldset>
      ...
      <div class="field">
        ...
        <select name="template">
          ...
          <option value="<?php echo html($value) ?>"<?php if(get('template', 'post') == $value) echo ' selected="selected"' ?>><?php echo html(data::templateName($value)) ?> (<?php echo html($value) ?>)</option>
          <?php endforeach ?>
        </select>
        <?php endif ?>
      </div>
